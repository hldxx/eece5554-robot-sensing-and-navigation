...
bag = rosbag('/home/xuhe/Documents/MATLAB/stationary_occlusion.bag');
...
altitude = ones(1,222);
latitude = ones(1,222);
longitude = ones(1,222);
utmEasting = ones(1,222);
utmNorthing = ones(1,222);
i=1;
...
subplot(2,2,1:2);
plot (time,altitude);
title('altitude change in stationary data(occlusion)');
xlabel('time(s)');
ylabel('altitude(m)');
